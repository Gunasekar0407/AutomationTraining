...
public class MyntraScreenShotTwo {
        WebDriver webDriver;
        ...
        public void searchProduct() throws IOException {
            ...
            try {
            List<WebElement> watches = webDriver.findElements(By.xpath(properties.getProperty("wrongXpath")));
            ...
            List<WebElement> ratings = webDriver.findElements(By.xpath(properties.getProperty("wrongXpath")));
